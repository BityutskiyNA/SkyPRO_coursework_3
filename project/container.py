...
from project.services import Favorite_movie_service
...
favorite_movie_dao = Favorite_movieDAO(db.session)
...
favorite_movie_service = Favorite_movie_service(dao=favorite_movie_dao)
